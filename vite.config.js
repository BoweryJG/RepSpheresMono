...
// Custom plugin to exclude Node.js-only packages from browser bundle - REMOVED
...
export default defineConfig(({ mode }) => {
  ...
  return {
    plugins: [
      react(),
      browserSafetyPlugin()
      // nodeModulesExcludePlugin has been removed
    ],
    resolve: {
      alias: {
        'colors': path.resolve(__dirname, 'src/mocks/colors.js'),
        'colors/safe': path.resolve(__dirname, 'src/mocks/colors.js'),
        'colors/safe.js': path.resolve(__dirname, 'src/mocks/colors.js'),
      },
    },
    server: {
